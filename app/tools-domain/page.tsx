        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="flex space-x-8">
              <Link href="/tools-domain" className="text-slate-600 hover:text-slate-900 px-3 py-2 rounded-md text-sm font-medium">
                Home
              </Link>
              <Link href="/tools-domain/memorizer" className="text-slate-600 hover:text-slate-900 px-3 py-2 rounded-md text-sm font-medium">
                Memorizer
              </Link>
              <Link href="https://bonnevalsolutions.com" className="text-slate-600 hover:text-slate-900 px-3 py-2 rounded-md text-sm font-medium">
                Main Site
              </Link>
            </nav>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 text-center">
          <p className="text-slate-500">
            © 2024 Preview Bonneval Solutions. Professional tools for business automation.
          </p>
        </div>
      </main>
    </div>
