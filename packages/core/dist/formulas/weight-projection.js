...
exports.projectWeight = projectWeight;
exports.calculateProjectionCI = calculateProjectionCI;
 ...
 */
function projectWeight({ currentWeightKg, dailyDeficitKcal, horizonWeeks, adaptiveModel = false, adaptationRate = 0.5, // 0.5% per week
 }) {
    const projections = [];
    ...
    for (let week = 1; week <= horizonWeeks; week++) {
        ...
        const weightLossKg = cumulativeDeficit / constants_1.KCAL_PER_KG_BODY_WEIGHT;
 ...
 */
function calculateProjectionCI(projections, confidencePercent = 5) {
